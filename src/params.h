...
double get_model_param_app_users_fraction(model *pmodel, int idx);
double get_total_app_users_fraction(model *pmodel);
...
int set_model_param_app_users_fraction(model *pmodel, double value, int idx);
